        ...
        <div className="container mx-auto py-12 px-4">
              ...
              <button
                className={`px-4 py-2 rounded-md ${
                  activeTab === "featured"
                    ...
                    : "text-gray-600 dark:text-gray-300 hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-400"
                }`}
          ...
          <div className="mt-16 bg-white dark:bg-gray-800 p-8 rounded-lg shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">
              Warum Your Drive wählen?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <FaStar className="w-8 h-8 text-gray-600 dark:text-gray-400 dark:text-gray-400 mx-auto mb-4" />
              ...
              <div className="text-center">
                <FaTag className="w-8 h-8 text-gray-600 dark:text-gray-400 dark:text-gray-400 mx-auto mb-4" />
                <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">
                  Beste Preise
                </h3>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <div className="text-center">
                <FaClock className="w-8 h-8 text-gray-600 dark:text-gray-400 dark:text-gray-400 mx-auto mb-4" />
                <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">
                  24/7 Support
                </h3>
                <p className="text-gray-600 dark:text-gray-300">
