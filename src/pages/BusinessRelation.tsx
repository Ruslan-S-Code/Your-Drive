...
export default function BusinessRelation() {
  const benefits = [
    {
      icon: <FaBuilding className="w-8 h-8 text-orange-500" />,
    ...
    {
      icon: <FaCar className="w-8 h-8 text-orange-500" />,
    ...
    {
      icon: <FaHeadset className="w-8 h-8 text-orange-500" />,
      title: "24/7 Service",
        ...
        <div className="container mx-auto py-12 px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Your Drive bietet spezielle Lösungen für Unternehmen, die ihre
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4">
              <a
                ...
                className="bg-orange-500 text-white px-6 py-2 rounded-md hover:bg-orange-600 transition-colors shadow-md hover:shadow-lg"
              >
                +49 123 456 789
              </a>
              <a
                href="mailto:business@yourdrive.com"
                className="bg-orange-500 text-white px-6 py-2 rounded-md hover:bg-orange-600 transition-colors shadow-md hover:shadow-lg"
              >
                business@yourdrive.com
              </a>
            </div>
          </div>
        </div>
