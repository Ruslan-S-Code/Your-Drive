...
export default function About() {
  ...
  const values = [
    ...
    {
      icon: <FaLeaf className="text-4xl text-gray-600 dark:text-gray-400" />,
  ...
  const team = [
    {
      ...
      bio: "Mit über 15 Jahren Erfahrung in der Automobilbranche führt Sarah Your Drive mit Vision und Innovation."
    },
    {
      name: "Michael Weber",
    ...
    },
    {
      ...
      bio: "Lisa entwickelt innovative Marketingstrategien, die Your Drive als führende Marke positionieren."
    },
    {
      name: "Thomas Becker",
      ...
      <main>
        ...
        <section className="bg-gray-900 text-white py-20">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Über Your Drive</h1>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="prose prose-lg mx-auto">
                <p>
                  Your Drive wurde 2015 mit einer Vision gegründet: Die Fahrzeugmiete sollte einfacher, 
        ...
        <section className="py-16 bg-gray-900 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">Werden Sie Teil der Your Drive-Familie</h2>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <a 
                href="/contact" 
                className="bg-transparent border border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-800 transition-colors"
              >
                Kontakt aufnehmen
              </a>
            </div>
